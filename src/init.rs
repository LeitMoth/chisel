...
use bevy_mod_raycast::{NoBackfaceCulling, RaycastMesh, DefaultPluginState};

use crate::{
    geometry::{planes_to_sides, side_to_lines, side_to_triangles, StandardPlane},
    solidcomp::SolidComponent,
    vmf2::res::{ActiveVmf, VmfFile}, controls::{Selected, MyRaycastSet, ControlNob, OrthoRaycastSet},
};
    ...
    if active_vmf.is_changed() {
            ...
            .and_then(|handle| vmfs_files.get(handle))
        {
            ...
            for solid in &vmf.vmf.world.solids {
                ...
                let planes: Vec<StandardPlane> = vmf_sides.iter()
